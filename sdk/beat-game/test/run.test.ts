...
describe("beat-game run lifecycle", () => {
  ...
  it("evades a ranged attacker barehanded while recovering a corpse", async () => {
    const driver = new FakeBeatGameDriver();
    const store = new InMemoryBeatGameCheckpointStore();
    const deathPosition = {
      x: 48,
  ...
  it("does not mistake an unrelated hostile drop for corpse recovery", async () => {
    const driver = new FakeBeatGameDriver();
    const store = new InMemoryBeatGameCheckpointStore();
    const deathPosition = {
      x: 80,
  ...
  it("fights a ranged hostile already inside melee range at critical health", async () => {
    const driver = new FakeBeatGameDriver();
  ...
  it("turns and fights when a ranged attacker closes the gap during escape", async () => {
    const driver = new FakeBeatGameDriver();
