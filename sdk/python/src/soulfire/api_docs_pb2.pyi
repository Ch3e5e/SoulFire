...
class ApiMethodDocs(_message.Message):
    __slots__ = ("display_name", "description", "permissions", "scope", "preconditions", "execution", "side_effects")
    ...
    def __init__(self, display_name: _Optional[str] = ..., description: _Optional[str] = ..., permissions: _Optional[_Iterable[str]] = ..., scope: _Optional[str] = ..., preconditions: _Optional[_Iterable[str]] = ..., execution: _Optional[str] = ..., side_effects: _Optional[_Iterable[str]] = ...) -> None: ...
