 ...
 * This can be a Microsoft account (Java or Bedrock), TheAltening Java account,
 * raw Java access-token account, or offline account.
 ...
 */
export type MinecraftAccountProto = Message<"soulfire.v1.MinecraftAccountProto"> & {
  /**
   ...
   * For online accounts: The profile UUID returned by the authentication provider.
  ...
  accountData: {
    ...
    /**
     * Data for Java accounts authenticated through TheAltening.
     *
     * @generated from field: soulfire.v1.MinecraftAccountProto.TheAlteningJavaData the_altening_java_data = 11;
     */
    value: MinecraftAccountProto_TheAlteningJavaData;
    case: "theAlteningJavaData";
 ...
 */
export type MinecraftAccountProto_OnlineChainJavaData = Message<"soulfire.v1.MinecraftAccountProto.OnlineChainJavaData"> & {
  /**
   ...
   */
  authChain?: JsonObject | undefined;
};
 ...
 */
export type MinecraftAccountProto_OfflineJavaData = Message<"soulfire.v1.MinecraftAccountProto.OfflineJavaData"> & {
};
 ...
 */
export type MinecraftAccountProto_OnlineSimpleJavaData = Message<"soulfire.v1.MinecraftAccountProto.OnlineSimpleJavaData"> & {
  /**
 ...
 * Stores the imported account token and the current Yggdrasil access token.
 *
 * @generated from message soulfire.v1.MinecraftAccountProto.TheAlteningJavaData
 */
export type MinecraftAccountProto_TheAlteningJavaData = Message<"soulfire.v1.MinecraftAccountProto.TheAlteningJavaData"> & {
  /**
   * The raw TheAltening account token used to authenticate and refresh this account.
   *
  ...
  /**
   * The current Yggdrasil access token returned by TheAltening.
   *
...
/**
 * Describes the message soulfire.v1.MinecraftAccountProto.TheAlteningJavaData.
 ...
 */
export type MinecraftAccountProto_BedrockData = Message<"soulfire.v1.MinecraftAccountProto.BedrockData"> & {
  /**
...
export enum MinecraftAccountProto_AccountTypeProto {
  ...
  /**
   * Authenticated via TheAltening account token.
   * Account data stored in TheAlteningJavaData.
   *
   * @generated from enum value: THE_ALTENING = 10;
   */
  THE_ALTENING = 10,
}
 ...
 */
export type SettingsNamespace_SettingsEntry = Message<"soulfire.v1.SettingsNamespace.SettingsEntry"> & {
  /**
 ...
 */
export type SettingsEntryIdentifier = Message<"soulfire.v1.SettingsEntryIdentifier"> & {
  /**
...
export type MinMaxSetting = Message<"soulfire.v1.MinMaxSetting"> & {
   ...
   */
  minEntry?: MinMaxSetting_Entry | undefined;
   ...
   */
  maxEntry?: MinMaxSetting_Entry | undefined;
...
export type SettingsPage = Message<"soulfire.v1.SettingsPage"> & {
   ...
   */
  owningPluginId?: string | undefined;
   ...
   */
  enabledIdentifier?: SettingsEntryIdentifier | undefined;
};
...
export enum AccountTypeCredentials {
  ...
  /**
   * TheAltening Java Edition authentication using a generated account token.
   * Authenticates against TheAltening's Yggdrasil-compatible auth server.
   * Payload format: raw TheAltening account token string.
   *
   * @generated from enum value: THE_ALTENING = 8;
   */
  THE_ALTENING = 8,
}
 ...
 */
export const AccountTypeCredentialsSchema: GenEnum<AccountTypeCredentials> = /*@__PURE__*/
 ...
 */
export const AccountTypeDeviceCodeSchema: GenEnum<AccountTypeDeviceCode> = /*@__PURE__*/
 ...
 */
export const GlobalPermissionSchema: GenEnum<GlobalPermission> = /*@__PURE__*/
...
export enum InstancePermission {
  ...
  /**
   * Permission to change which bots should be connected.
   * Required by BotService.SetBotsDesiredState and RestartBots.
   *
   * @generated from enum value: CONTROL_BOTS = 21;
   */
  CONTROL_BOTS = 21,

  /**
   * Permission to activate, deactivate, and dry-run scripts.
   *
   * @generated from enum value: EXECUTE_SCRIPTS = 22;
   */
  EXECUTE_SCRIPTS = 22,
}
 ...
 */
export const InstancePermissionSchema: GenEnum<InstancePermission> = /*@__PURE__*/
 ...
 */
export const SettingsPageEntryScopeTypeSchema: GenEnum<SettingsPageEntryScopeType> = /*@__PURE__*/
