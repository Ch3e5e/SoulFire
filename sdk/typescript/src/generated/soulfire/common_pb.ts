...
export enum InstancePermission {
  ...
  /**
   * Permission to control a connected bot in the Minecraft world.
   * Required for chat, movement, inventory, interaction, and pathfinding RPCs.
   * This is deliberately separate from UPDATE_BOT_CONFIG so operators can
   * script bots without changing persistent settings.
   *
